  ...
  return (
    <div className="relative w-full h-96 rounded-lg overflow-hidden shadow-2xl">
      ...
      <button
        ...
        className="absolute w-10 left-2 top-1/2 transform -translate-y-1/2 bg-black/20 hover:bg-black/40 text-white p-1 rounded-full transition-all duration-300 z-20 backdrop-blur-sm"
      ...
      <button
        ...
        className="absolute w-10 right-2 top-1/2 transform -translate-y-1/2 bg-black/20 hover:bg-black/40 text-white p-1 rounded-full transition-all duration-300 z-20 backdrop-blur-sm"
